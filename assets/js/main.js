...
(function() {
  ...
  window.addEventListener('load', function(e) {
    ...
    document.addEventListener("DOMContentLoaded", function () {
        ...
        typingElement.classList.add("typing-container");
        typeEffect();
    });
...
// JavaScript for expanding/collapsing project details
document.querySelectorAll('.show-more-btn').forEach(button => {
  button.addEventListener('click', function() {
    const projectCard = this.closest('.portfolio-card');
    const moreDetails = projectCard.querySelector('.more-details');
    ...
    if (moreDetails.style.display === 'none' || moreDetails.style.display === '') {
      ...
      this.textContent = 'Show More';  // Reset the button text
    }
  });
});
